...
- Screenshots are optional; the model does not consume them. Demonstration footage may be sped up, but any speed other than 1× is shown on the video itself (e.g. "1.5× SPEED"), and every timing quoted in text is real time.
